...
- **Cloudflare Pages:** connect this repository, leave the build command empty and set the build
  output directory to `web`. `web/_headers` adds a strict Content-Security-Policy.
